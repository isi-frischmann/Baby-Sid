...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <h2 class="mt-4">Hello Nanny <c:out value="${ nanny.fname }" /></h2>
                <p>Parents are looking for you to take care of there kids.<p>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4 my-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Review a Parent</h4>
                        <p class="card-text">Please share your experience with one of your Parent's and there kids you took care of recently!</p>
                    </div>
            ...
            <div class="col-sm-4 my-4">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="index.html" class="btn btn-info">Update your Profile!</a>
                    </div>
                </div>
            </div>
